    ...
    <FormModal
      ...
      footer={
        <FormFooter
          ...
          submitLabel={createProductMutation.isPending ? 'Creating...' : 'Create Product'}
          submitIcon={createProductMutation.isPending ? <Loader2 className="animate-spin mr-2 h-4 w-4" /> : <Package className="mr-2 h-4 w-4" />}
        />
      }
    >
