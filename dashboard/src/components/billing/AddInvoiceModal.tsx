...
interface InvoiceItemWithProduct
  ...
  variantUuid?: string // UUID for the product variant, if applicable
...
const AddInvoiceModal: React.FC<AddInvoiceModalProps> = ({ isOpen, onClose, onSuccess, jobs }) => {
  ...
  const addProductVariantToInvoice = (variant: ProductVariant & { productName: string }) => {
    ...
    setItems((prevItems) => {
      ...
      const existingItemIndex = prevItems.findIndex((item) => item.variantUuid === newItem.variantUuid)
                    ...
                    <div key={index} className="grid grid-cols-12 gap-4 items-end">
                      <div className="col-span-5">
                        ...
                        <input
                          ...
                          readOnly={!!item.variantUuid} // Make read-only if it's a product variant
                        />
