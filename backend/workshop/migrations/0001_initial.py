...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='booking',
            name='time_slot',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookings', to='workshop.bookingtimeslot'),
        ),
        migrations.AddField(
            model_name='booking',
            name='car',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookings', to='workshop.car'),
        ),
        migrations.AddField(
            model_name='car',
            name='customer',
        ...
        migrations.AddField(
            model_name='booking',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookings', to='workshop.customer'),
        ),
        migrations.CreateModel(
            name='Invoice',
            fields=[
        ...
        migrations.AddIndex(
            model_name='booking',
            index=models.Index(fields=['time_slot'], name='booking_time_sl_5db0b0_idx'),
        ),
        migrations.AddIndex(
            model_name='booking',
