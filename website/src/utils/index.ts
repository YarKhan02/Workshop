...
export const getStaffRoleColor = (role: StaffRole) => {
  switch (role) {
    case StaffRole.MANAGER:
      return 'bg-purple-100 text-purple-800';
    case StaffRole.DETAILER:
      return 'bg-blue-100 text-blue-800';
...
// Inventory category utilities
export const getInventoryCategoryColor = (category: InventoryCategory) => {
  switch (category) {
    case InventoryCategory.CLEANING_SUPPLIES:
      return 'bg-blue-100 text-blue-800';
    case InventoryCategory.POLISHES:
      return 'bg-green-100 text-green-800';
    case InventoryCategory.WAXES:
      return 'bg-yellow-100 text-yellow-800';
